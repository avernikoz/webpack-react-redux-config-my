...
class Contact extends Component {
    ...
    render() {
        return (
            <div className={this.props.id === this.props.contactIdInUrl ? 'contact expanded' : 'contact'} onClick={this.expandContact} role="presentation">
                <img className="contact-image" src={this.props.img} alt="contact" />
